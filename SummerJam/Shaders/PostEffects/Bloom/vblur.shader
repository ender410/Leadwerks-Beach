...
void main(void)
{
	...
	fragData0 = vec4(0);
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.028))*0.0044299121055113265;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.024))*0.00895781211794;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.020))*0.0215963866053;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.016))*0.0443683338718;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.012))*0.0776744219933;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.008))*0.115876621105;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, -0.004))*0.147308056121;
	fragData0 += texture2D(texture0, icoord)*0.159576912161;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.004))*0.147308056121;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.008))*0.115876621105;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.012))*0.0776744219933;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.016))*0.0443683338718;
	...
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.024))*0.00895781211794;
	fragData0 += texture2D(texture0, icoord+ vec2(0.0, 0.028))*0.0044299121055113265;
	//fragData0 /= (0.00895781211794+0.0215963866053+0.0443683338718+0.0776744219933+0.115876621105+0.147308056121)*2.0 + 0.159576912161;
	//fragData0 = colour;
}
