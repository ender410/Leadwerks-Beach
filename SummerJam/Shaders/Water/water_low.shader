...
uniform vec4 camerabackgroundcolor;
...
void main(void)
{
	...
	cubecoord.y *= -1.0;
	outcolor = skybox * texture(texture0,cubecoord+normal*0.5) + (1.0-skybox)*camerabackgroundcolor;
	
	fragData0 = outcolor * materialcolordiffuse * brightness;
	fragData0.a = 0.75;
}
